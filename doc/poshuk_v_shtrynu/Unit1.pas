...
type
  TForm1 = class(TForm)
    ...
    procedure Label1MouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
    procedure width_search_tree_bild(A: TMatrix; X: TVECT; Y: TVECT; V: TVECT; N: integer; Image: TImage);
    ...
    procedure bbNewGraphClick(Sender: TObject);
  private
...
var
  MAS_X, MAS_Y, MAS_N, V, V0, V1, V2: TVECT;
  Edges, A1: TMatrix;
...
begin
     OpenURL('http://www.mathros.net.ua/obhid-grafa-v-shyrynu.html'); { *Перетворено з ShellExecute* }
end;
...
procedure TForm1.bbWidthClick(Sender: TObject);
var
...
procedure TForm1.width_search_tree_bild(A: TMatrix; X, Y, V: TVECT; N: integer;
  Image: TImage);
var
   i, j: integer;
begin
...
procedure TForm1.bbNewGraphClick(Sender: TObject);
var
   i, j: integer;
begin
     depth := false;
